...
import { ITool, ICommand, IParameter } from "../definitions";
 ...
 */
export function convertCommandIntoRegexString(tool: ITool, cmd: ICommand, useNaming = false) {

	//the following regex is created:
	//^{tool-name} {command-name or alias list} {capture of the rest}$
	let regexString = "^";
