...
export class Options implements IOptions {
	...
	public reloadNodeModules: boolean;

	constructor() {
		this.showInvalidSyntax = getB("HCM_SHOW_INVALID_SYNTAX", true);
		//this.showHelpOnInvalidSyntax = getB(
		//	"HCM_SHOW_HELP_ON_INVALID_SYNTAX",
		//	true
		//);
		...
		this.reloadNodeModules = getB("HCM_RELOAD_NODE_MODULES", false);
	}
}
